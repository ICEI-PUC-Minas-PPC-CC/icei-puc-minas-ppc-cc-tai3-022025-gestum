...
module.exports = (sequelize, DataTypes) => {
  ...
  Empresa.associate = (models) => {
    ...
    // 1:N
    Empresa.hasMany(models.Funcionario, { foreignKey: 'fk_empresa_id_empresa', as: 'funcionarios' });
    Empresa.hasMany(models.Certificado, { foreignKey: 'fk_empresa_id_empresa', as: 'certificados' });
    Empresa.hasMany(models.Contrato, { foreignKey: 'fk_empresa_id_empresa', as: 'contratos' });
    Empresa.hasMany(models.Contato, { foreignKey: 'fk_empresa_id_empresa', as: 'contatos' });
    Empresa.hasMany(models.Endereco, { foreignKey: 'fk_empresa_id_empresa', as: 'enderecos' });

    // N:N opcionais (quando contrato/certificado puderem ser multi-empresa)

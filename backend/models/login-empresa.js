// /src/models/login-empresa.js
module.exports = (sequelize, DataTypes) => {
  const LoginEmpresa = sequelize.define('LoginEmpresa', {
  ...
  LoginEmpresa.associate = (models) => {
    LoginEmpresa.belongsTo(models.Empresa, { foreignKey: 'fk_empresa_id_empresa', as: 'empresa' });
  };
